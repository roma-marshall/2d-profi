        ...
        >
          ...
          >
            <button
              ...
              @click="selectPlanElementMode('terrace')"
            >
              Terrace
            </button>
            <button
              ...
              @click="selectPlanElementMode('special-elements')"
            >
              Special element
            </button>
          </div>

          <template v-if="planElementMode === 'terrace'">
          ...
          <template v-else>
            ...
            <template v-if="selectedSpecialElement && selectedSpecialOption">
              ...
              <button
                ...
                @click="
                  emit('remove-special-element', selectedSpecialElement.id)
                "
              >
                Remove element
              </button>
